...
public abstract class Hilt_GeneralInfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GeneralInfoFragment() {
    super();
  }

  Hilt_GeneralInfoFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GeneralInfoFragment_GeneratedInjector) this.generatedComponent()).injectGeneralInfoFragment(UnsafeCasts.<GeneralInfoFragment>unsafeCast(this));
    }
  }
