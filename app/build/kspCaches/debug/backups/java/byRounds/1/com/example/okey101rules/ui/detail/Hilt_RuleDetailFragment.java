...
public abstract class Hilt_RuleDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RuleDetailFragment() {
    super();
  }

  Hilt_RuleDetailFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RuleDetailFragment_GeneratedInjector) this.generatedComponent()).injectRuleDetailFragment(UnsafeCasts.<RuleDetailFragment>unsafeCast(this));
    }
  }
