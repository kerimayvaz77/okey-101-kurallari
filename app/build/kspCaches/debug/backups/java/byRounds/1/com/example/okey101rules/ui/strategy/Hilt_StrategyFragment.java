...
public abstract class Hilt_StrategyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StrategyFragment() {
    super();
  }

  Hilt_StrategyFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StrategyFragment_GeneratedInjector) this.generatedComponent()).injectStrategyFragment(UnsafeCasts.<StrategyFragment>unsafeCast(this));
    }
  }
