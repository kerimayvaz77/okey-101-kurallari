...
public final class DialogStrategyDetailBinding implements ViewBinding {
  @NonNull
  ...
  private DialogStrategyDetailBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static DialogStrategyDetailBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogStrategyDetailBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_strategy_detail, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogStrategyDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogStrategyDetailBinding((ConstraintLayout) rootView, backgroundOverlay,
          buttonExit, dialogCard, iconContainer, textViewDetailDescription, textViewDetailEmoji,
          textViewDetailTitle);
    }
