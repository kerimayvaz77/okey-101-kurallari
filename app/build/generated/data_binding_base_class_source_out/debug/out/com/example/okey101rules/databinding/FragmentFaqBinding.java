...
public final class FragmentFaqBinding implements ViewBinding {
  ...
  private FragmentFaqBinding(@NonNull ScrollView rootView, @NonNull ProgressBar progressBar,
      @NonNull RecyclerView recyclerViewFaq) {
  ...
  public static FragmentFaqBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFaqBinding((ScrollView) rootView, progressBar, recyclerViewFaq);
    }
